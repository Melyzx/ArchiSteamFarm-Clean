...
ASF має підтримку для користувацьких плагінів, які можуть бути завантажені протягом роботи. Plugins allow you to customize ASF behaviour, for example by adding custom commands, custom trading logic or whole integration with third-party services and APIs.
