...
параметр типу `byte` зі значенням за замовчуванням `0`. This property defines plugins update mode that gives meaning to `PluginsUpdateList` defined above. By specifying this property you can easily enable/disable automatic updates for all plugins except those declared.
...
| Value | Ім'я                          | Description                                                                                              |
| ----- | ----------------------------- | -------------------------------------------------------------------------------------------------------- |
| 0     | Не обрано                     | No special bot behaviour, sane default settings                                                          |
...
| Value | Ім'я        | Description                            |
| ----- | ----------- | -------------------------------------- |
| 0     | Не обрано   | No special online preferences, default |
