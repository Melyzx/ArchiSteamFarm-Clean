...
* [An ninh / Bảo mật / VAC / Chặn / Điều khoản dịch vụ](#security--privacy--vac--bans--tos)
* [Những thứ khác](#misc)
* [Các vấn đề](#issues)
...
### ASF là gì?
### Vì sao phần mềm khẳng định rằng không có gì để cày trên tài khoản của tôi?
### Vì sao ASF không nhận diện được tất cả trò chơi của tôi?
### Vì sao tài khoản tôi bị giới hạn?

Trước khi cố gắng hiểu ASF là cái gì, bạn nên chắc chắn rằng bạn hiểu thẻ Steam là gì, và làm thế nào để có chúng, việc đã được mô tả kĩ càng trong FAQ chính thức **[ở đây](https://steamcommunity.com/tradingcards/faq)**.

Nói ngắn gọn, thẻ Steam là vật dụng thu thập được khi bạn đủ điều kiện mà bạn sở hữu một trò chơi nhất định, và có thể sử dụng chúng để tạo huy hiệu, bán trên chợ Steam hoặc cho bất kỳ mục đích khác mà bạn muốn.

Những điểm chính lại được nhắc lại ở đây, vì mọi người nói chung không muốn đồng ý với chúng và thích coi chúng như không có tồn tại:

- **Bạn cần sở hữu trò chơi trên tài khoản Steam của bạn để có điều kiện cho thẻ bất kỳ nào rớt từ nó. Chế độ Chia sẻ gia đình sẽ không tính.**
- **Trò chơi của bạn không thể được đánh dấu là [riêng tư](https://help.steampowered.com/faqs/view/1150-C06F-4D62-4966), ASF sẽ tự động bỏ qua trò chơi đã đánh dấu như vậy trong khi cày.**
- **Bạn không thể cày trò chơi một cách vô tận được, mọi trò chơi đều có một số lượng thẻ rơi nhất định. Một khi bạn đã làm rớt hết tất cả thẻ (khoảng một nửa số thẻ của bộ thẻ đầy đủ), trò chơi sẽ không nằm trong phần khả năng có thể cày được nữa. Không quan trọng việc bạn đã bán, đổi, chế tạo hoặc quên mất chuyện gì đã xảy ra với những thẻ bạn đã nhận được, khi bạn đã hết lần rớt thẻ rồi, thì trò chơi đã được cày hết.**
- **Bạn không thể làm rơi thẻ từ trò chơi F2P (miễn phí để chơi) mà không tiêu tiền vào chúng. Đây có nghĩa là những trò chơi miễn phí vĩnh viễn như Team Fortress 2 hay Dota 2. Sỡ hữu trò chơi miễn phí sẽ không cho bạn lần rớt thẻ nào cả.**
- **Bạn không thể làm rơi thẻ trên [tài khoản bị giới hạn](https://help.steampowered.com/faqs/view/71D3-35C2-AD96-AA3A), dù bất kể trò chơi nào bạn sở hữu đi chăng nữa. Việc này có khả thi trước đó, nhưng giờ nó không còn có thể làm được nữa.**
- **Trò chơi trả phí mà bạn đã nhận được miên phí trong khi có khuyến mãi không thể cày để rơi thẻ được, dù bất kể những thứ gì được hiển thị trên trang cửa hàng đi chăng nữa. Việc này có khả thi trước đó, nhưng giờ nó không còn có thể làm được nữa.**

Vậy như bạn thấy đấy, thẻ Steam được thưởng cho bạn khi bạn chơi trò chơi mà bạn đã mua, hoặc trò chơi miễn phí mà bạn đã bỏ tiền vào chúng. If you play such game long enough, all cards for that game will eventually drop to your inventory, making it possible for you to complete a badge (after obtaining the remaining half of the set), sell them, or do whatever else you want.
...
ASF logs into your Steam account through our built-in, custom Steam client implementation using your provided credentials. After successfully logging in, it parses your **[badges](https://steamcommunity.com/my/badges)** in order to find games that are available for farming (`X` card drops remaining). Sau khi phân tích tất cả các trang và xây dựng danh sách cuối cùng của các trò chơi có sẵn, ASF sẽ chọn thuật toán cày hiệu quả nhất và bắt đầu quá trình cày. The process depends upon chosen **[cards farming algorithm](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Performance)** but usually it consists of playing eligible game and periodically (plus on each item drop) checking if game is fully farmed already - if yes, ASF can proceed with the next title, using the same procedure, until all games are fully farmed.
...
### Tôi có cần phải nhập thông tin tài khoản không?

**Có**. ASF requires your account credentials in the same way as official Steam client does, as it's using the same method for Steam network interaction. This however doesn't mean that you have to put your account credentials in ASF configs, you can keep using ASF with `null`/empty `SteamLogin` and/or `SteamPassword`, and input that data on each ASF run, when required (as well as several other login credentials, refer to configuration). This way your details are not saved anywhere, but of course ASF can't autostart without your help. ASF also offers several other ways of increasing your **[security](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Security)**, so feel free to read that part of the wiki if you're advanced user. If you're not, and you don't want to put your account credentials in ASF configs, then simply don't do that, and instead input them as-needed when ASF asks for them.

Hãy lưu ý rằng công cụ ASF là cho việc sử dụng cá nhân của bạn và thông tin cá nhân của bạn sẽ không bao giờ rời khỏi máy tính bạn. Bạn cũng không đang chia sẻ với ai khác cả, thỏa mãn **[ĐKDV của Steam](https://store.steampowered.com/subscriber_agreement)** - một thứ rất quan trọng mà nhiều người đều quên mất. Bạn cũng không đang gửi thông tin chi tiết của bạn tới máy chủ của chúng tôi hay của bên thứ ba nào cả, chỉ gửi trực tiếp tới máy chủ Steam được Valve điều hành. Chúng tôi không biết thông tin cá nhân của bạn và chúng tôi cũng không thể khôi phục lại chúng cho bạn, cho dù bạn có bỏ chúng vào phần cấu hình của bạn đi chăng nữa.

---

### Tôi phải chờ bao lâu để các thẻ được rớt ra?

**Dài nhất có thể** - nghiêm túc đấy. Mọi trò chơi có độ khó cày thẻ khác nhau được đặt bởi nhà phát triển/nhà phát hành, và việc thẻ rơi nhanh hay không là tùy theo họ. Phần lớn trò chơi sẽ rơi thẻ sau khoảng 30 phút chơi, nhưng cũng sẽ có các trò chơi yêu cầu bạn phải chơi nhiều tiếng hơn trước khi rơi thẻ. In addition to that, your account could be restricted from receiving card drops from games you didn't play for enough time yet, as stated in **[performance](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Performance)** section. Do not attempt to make guesses how long ASF should farm given title - it's not up to you, neither ASF to decide. There is nothing you can do to make it faster, and there is no "bug" related to cards not being dropped in timely fashion - you do not control cards dropping process, neither does ASF. In the best case, you'll receive average of 1 drop per 30 minutes. In the worst case, you won't receive any card even for 4 hours since starting ASF. Both of those situations are normal and covered in our **[performance](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Performance)** section.

---

### Cày thẻ tốn quá lâu thật, làm thế nào để tăng tốc nó đây?
...
### Nhưng ASF nói rằng cày sẽ tốn khoảng X thời gian mà!
...
### ASF có thể hoạt động trên điện thoại/thiết bị Android của tôi không?
...
### ASF có thể cày các vật phẩm từ các trò chơi trên Steam, như CS:GO hay Unturned không?

**Không**, việc này là đi ngược lại **[ĐKDV của Steam](https://store.steampowered.com/subscriber_agreement)** và Valve đã nhắc việc này rất rõ ràng với làn sóng chặn cộng đồng trước đó vì đã cày đồ từ TF2. ASF là một phần mềm cày thẻ Steam, không phải là phần mềm cày vật phẩm trò chơi - nó không có khả năng nào để cày vật phẩm trò chơi, và không có kế hoạch để thêm chức năng như thế này trong tương lai và mãi mãi luôn, vì phần lớn là sẽ vi phạm điều khoản sử dụng của Steam. Làm ơn không được hỏi về chuyện này, vì chuyện tốt nhất bạn sẽ bị là báo cáo từ những người dùng khó chịu và bạn sẽ dính vào rắc rối đấy. Việc này cũng tương tự với các loại cày khác, như cày đồ rớt từ các đợt phát sóng CS:GO. ASF is focusing on Steam trading cards exclusively.

---

### Tôi có thể chọn trò chơi nào đó để được cày không?
...
### Tôi không hứng thú với việc rơi thẻ, thay vào đó tôi muốn cày giờ chơi, có thể làm vậy không?

Có, ASF cho phép bạn làm vậy theo ít nhất nhiều cách.
...
### Tôi là người dùng Linux / macOS, vậy ASF có thể cày trò chơi không có sẵn trên hệ điều hành của tôi không? Liệu ASF có thể cày các trò chơi chạy 64-bit khi tôi đang chạy hệ điều hành 32-bit không?
...
### ASF có tương tự Idle Master không?
...
### Có đáng để dùng ASF không, khi mà tôi đang sử dụng Idle Master và nó hoạt động tốt với tôi?

**Có**. ASF is much more reliable and includes many built-in functions that are **crucial** regardless of the way how you farm, that IM simply doesn't offer.
...
### Những tính năng hấp dẫn nào ASF mang lại mà Idle Master không có?
...
### ASF có nhanh hơn Idle Master không?

**Có**, nhưng mà phần giải thích thì có hơi phức tạp.
...
### Nhưng liệu sự khác biệt có rõ ràng thế không?

Không. The interrupts that are happening with normal steam client and idle master have negligible effect on the card drops, so it's not any noticeable difference that would make ASF superior.
...
### ASF có thể cày nhiều trò chơi cùng một lúc không?
...
### ASF có thể bỏ qua trò chơi một cách nhanh chóng không?
...
### ASF có thể tự động chơi từng trò chơi trong vòng X giờ trước khi thẻ được thêm vào không?
...
## An ninh / Bảo mật / VAC / Chặn / Điều khoản dịch vụ

---

### Tôi có thể bị VAC chặn khi sử dụng không?
...
### Liệu dùng ASF có thể ngăn tôi không chơi trên các máy chủ được bảo mật VAC, như được nêu **[ở đây](https://help.steampowered.com/faqs/view/22C0-03D0-AE4B-04E8)** không?
...
### Tôi có thể bị chặn do cái này không?
...
### Tôi đang dùng hệ điều hành không được hỗ trợ như là Windows 32-bit, liệu tôi có thể sử dụng được phiên bản mới nhất của ASF không?
...
### Tôi muốn giúp đỡ phần dịch thuật ASF, tôi cần phải làm gì đây?

Cảm ơn vì bạn đã quan tâm việc này! Bạn có thể thấy mọi chi tiết ở phần **[bản địa hóa](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Localization)** của chúng tôi.
...
Bạn thấy phần mã `Forbidden` đó không? This means that you got temporarily banned for excessive amount of requests, because you didn't tweak `WebLimiterDelay` properly yet (assuming you get the same error code for all other requests as well). There could be other reasons listed there, such as `InternalServerError`, `ServiceUnavailable` and timeouts that indicate Steam maintenance/issues. You can always try to visit the link mentioned by ASF yourself and check if it works - if it doesn't, then you know why ASF can't access that either. If it does, and the same error doesn't go away after a day or two, it may be worth investigating and reporting.
