...
Cảm ơn tất cả mọi người vì đã giúp đỡ trong việc phát triển ASF! Mọi người đều là người tuyệt vời :heart:.
...
### Được rồi, có điều kiện gì không? Bạn sẽ được lợi gì khi chia sẻ ASF?

Không có điều kiện gì cả, tôi tạo ASF **cho chính mình** và rồi sau đó chia sẻ với toàn bộ cộng đồng với hi vọng rằng nó sẽ có ích. Giống như chuyện đã xảy ra trước đó vào năm 1991, khi Linus Torvalds **[đã chia sẻ nhân hệ điều hành Linux đầu tiên của mình](https://groups.google.com/forum/#!msg/comp.os.Minix/dlNtH7RRrGA/SwRavCzVE7gJ)** với phần còn lại của thế giới. There is no hidden malware, data mining, crypto mining or any other activity that would generate any monetary benefit for me. ASF project is supported entirely by non-obligatory donations sent by happy users such as you. You can use ASF in exactly the same way how I'm using it, and if you like it, you can always buy me a coffee, showing your gratitude for what I'm doing.
...
Trên Windows, chúng ta có thể làm thế từ Powershell, nhưng mà bạn sẽ phải tự xác minh bằng `SHA512SUMS`:
...
This way we ensured that whatever was written to `SHA512SUMS` matches the resulting files and they weren't tampered with. However, it doesn't prove yet that `SHA512SUMS` file you checked against really comes from us. There are two ways to verify that.
...
### Hôm nay là mùng 1 tháng 4 và ngôn ngữ của ASF chuyển thành thứ gì đó rất lạ, chuyện gì xảy ra thế?
