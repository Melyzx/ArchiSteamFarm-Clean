...
Fona spēļu iegūšana ir speciāli iestrādāta ASF funkcija, kas ļauj importēt noteiktu Steam disku-atslēgu komplektu (kopā ar nosaukumiem), lai tos izmantotu fonā. This is especially useful if you have a lot of keys to redeem and you're guaranteed to hit `RateLimited` **[status](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/FAQ#what-is-the-meaning-of-status-when-redeeming-a-key)** before you're done with your entire batch.
