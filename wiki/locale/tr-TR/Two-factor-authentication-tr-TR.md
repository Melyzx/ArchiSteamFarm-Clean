...
Öncelikle ASF config dizininde yeni boş `BotName.maFile` oluşturun; burada ki `BotName`, ASF 2AD'yı eklediğiniz botunuzun adı olmalıdır. Yanlış ad verirseniz, ASF tarafından seçilmeyecektir.
