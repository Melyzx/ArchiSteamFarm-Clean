...
`tavu`-tyyppi, jonka oletusarvo on `0`. This property defines plugins update mode that gives meaning to `PluginsUpdateList` defined above. By specifying this property you can easily enable/disable automatic updates for all plugins except those declared.
...
| Value | Nimi                          | Description                                                                                              |
| ----- | ----------------------------- | -------------------------------------------------------------------------------------------------------- |
| 0     | Tyhjä                         | No special bot behaviour, sane default settings                                                          |
...
| Value | Nimi        | Description                            |
| ----- | ----------- | -------------------------------------- |
| 0     | Tyhjä       | No special online preferences, default |
