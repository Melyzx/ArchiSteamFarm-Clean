...
Para ser listado, tienes que cumplir algunos requisitos. Como mínimo, debes haber permitido `PublicListing` en `RemoteCommunication` (configuración predeterminada), `SteamTradeMatcher` habilitado en `TradingPreferences`, **[inventario público](https://steamcommunity.com/my/edit/settings)** en los ajustes de privacidad, tener una cuenta **[no limitada](https://help.steampowered.com/es/faqs/view/71D3-35C2-AD96-AA3A)**, y **[ASF 2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-es-ES#asf-2fa)** activo. Requisitos adicionales incluyen 2FA activo por lo menos 15 días, último cambio de contraseña superior a 5 días, no tener limitaciones de cuenta como bloqueos, baneos del mercado y de intercambio. Naturalmente, también debes tener al menos un artículo (intercambiable) en tu inventario del `MatchableTypes` especificado, tal como los cromos. Adicionalmente, los bots con más de `500000` artículos no son aceptados debido a que implica una sobrecarga excesiva, recomendamos dividir tu inventario entre varias cuentas en este caso.
...
Para usar esa opción, tienes que cumplir ciertos requisitos. Como mínimo, debes tener una cuenta **[no limitada](https://help.steampowered.com/es/faqs/view/71D3-35C2-AD96-AA3A)**, **[ASF 2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-es-ES#asf-2fa)**  activo y por lo menos un tipo de artículo válido en `MatchableTypes`, por ejemplo, los cromos. Requisitos adicionales incluyen 2FA activo por lo menos 15 días, último cambio de contraseña superior a 5 días, no tener limitaciones de cuenta como bloqueos, baneos del mercado y de intercambio.
