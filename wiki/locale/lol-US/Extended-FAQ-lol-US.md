...
WE CAN USE `gpg` UTILITY 4 DAT PURPOSE, BOTH ON **[LINUX](https://gnupg.org/download/index.html)** AN **[WINDOWS](https://gpg4win.org)** (CHANGE `gpg` COMMAND INTO `gpg.exe` ON WINDOWS).
